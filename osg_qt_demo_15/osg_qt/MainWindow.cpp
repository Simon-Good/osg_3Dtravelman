		...
		if(index != -1){
			...
			if(customerList->row(currentItem) == 0){
				...
				case 11:
					{
						content= tr(
							"变电所有主变一台，SF6继路器1台，电流互感器、电压互感器各3只，隔离刀闸4组<br>"
							"  ""主变压器：<br>"
							"厂家：常州变压器厂、额定容量：25000KVA、额定电压：高压110KV、低压10.5KV<br>"
							"额定电流：高压131.2A 、低压：1375A、采用分接开关调压方式、共7档<br>"
							"  ""&隔离刀闸：<br>"
							"主变中性点隔离刀闸7010、主变进线隔离刀闸7011、压变进线隔离刀闸7015、母线进线隔离刀闸9333<br>"
							"  ""SF6断路器：<br>"
							"型号S1-145F1、额定电压145KV、额定电流3150A<br>"
							"  ""CT&PT：<br>"
							"110KV户外电流互感器（CT）型号LB7-110W3,额定电流比2*100/5A<br>"
							"110KV电容式电压互感器（PT）型号WVB110-20H"
							);
						title=tr("变电所");
					}
					break;
